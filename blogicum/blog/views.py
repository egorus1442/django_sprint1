...
posts = [
    ...
    },
    {
        ...
        'text': '''Мы с Джоном работали вместе, используя все свои знания 
                ...
                нас ждал золотой амулет с магической силой. Вернувшись на берег, 
                мы были полны впечатлений и чувством выполненного долга, зная, 
                что это приключение останется в нашей памяти навсегда.''',
    },
]
